      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">
            Your meeting has been confirmed. Check your email for additional details.
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-base font-semibold text-gray-800">{bookingDetails.meetingTitle}</p>
                </div>
                ...
                {bookingDetails.meetingLink && (
                  <div>
                    ...
                    <p className="text-base font-semibold text-blue-600">
                      <a href={bookingDetails.meetingLink} target="_blank" rel="noopener noreferrer" className="hover:underline">
                        {bookingDetails.meetingLink}
                      </a>
                    </p>
                  </div>
                ...
                {bookingDetails.location && (
                  <div>
                    ...
                    <p className="text-base font-semibold text-gray-800">{bookingDetails.location}</p>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-200 p-6 mb-8">
          ...
          <div className="space-y-3 text-sm text-gray-700">
            ...
            <div className="flex items-start">
              ...
              <p>For online meetings, the meeting link is provided above</p>
            </div>
            <div className="flex items-start">
              ...
              <p>Please join 5 minutes early for your meeting</p>
            </div>
          </div>
        </div>
...
export default MeetingVerificationPage;
